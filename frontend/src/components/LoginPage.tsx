      ...
      >
        ...
        <div className="login-social-grid">
          <button 
            ...
            onClick={() => window.location.href = import.meta.env.PROD ? `${import.meta.env.VITE_API_URL}/api/auth/google` : '/api/auth/google'}
          >
          ...
          <button 
            ...
            onClick={() => window.location.href = import.meta.env.PROD ? `${import.meta.env.VITE_API_URL}/api/auth/facebook` : '/api/auth/facebook'}
          >
